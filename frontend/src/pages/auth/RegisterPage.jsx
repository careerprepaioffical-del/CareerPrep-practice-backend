...
const RegisterPage = () => {
  ...
  const { register: registerUser, requestSignupOtp, loading, error } = useAuth();
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center mb-4">
        <Link to="/" className="btn btn-secondary px-4 py-2 rounded-xl text-sm font-semibold shadow-sm hover:bg-slate-100 transition-all">
          Home
        </Link>
      </div>
